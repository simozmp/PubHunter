...
/**
 * Implementation of an TableServiceDAO
 */
public class TableServiceDAOImpl extends JDBCDataAccessObjectImpl implements TableServiceDAO {
    @Override
    ...
    /**
     * Sets up a PreparedStatement with data from tableService (opened date, opened time, closed date,
